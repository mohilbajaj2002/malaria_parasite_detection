...
To initiate, add your preferences to the config.py file and then run main.py. Once model(s) have been trained, update the prediction section in the config file and use prediction.py to make prediction. 
